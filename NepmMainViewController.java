...
public class NepmMainViewController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        //初始化图片
        Image image = new Image("image/welcome.jpg");
    ...
    public void aqiStatistics() {
        JavafxUtil.showSubStage(NepmMain.class, "view/NepmAqiStatisticsView.fxml", primaryStage, "AQI信息统计");
    }
}
